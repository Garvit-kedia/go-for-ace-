...
const cardObjectDefinitions = [
    {id:1, imagePath:'../GAME_IMAGES/card-KingHearts.png'},
    {id:2, imagePath:'../GAME_IMAGES/card-JackClubs.png'},
    {id:3, imagePath:'../GAME_IMAGES/card-QueenDiamonds.png'},
    {id:4, imagePath:'../GAME_IMAGES/card-AceSpade.png'}
]
const aceId = 4

const cardBackImgPath = '../GAME_IMAGES/card image.jpg'
...
function gameOver()
{
    ...
    updateStatusElement(currentGameStatusElem,"block",'white',gameOverMessage)
...
function chooseCard(card)
{
    if(canChooseCard())
    {
        ...
        setTimeout(() => {
            flipCards(false)
            updateStatusElement(currentGameStatusElem,"block", 'cyan',"Card positions revealed")
...
{
    calculateScore()
    updateStatusElement(scoreElem, "block", 'lightblue', `Score <span class='badge'>${score}</span>`)
...
function initializeNewGame(){
    ...
    updateStatusElement(scoreElem,"block",'lightblue',`Score <span class='badge'>${score}</span>`)
    updateStatusElement(roundElem,"block",'lightblue',`Round <span class='badge'>${roundNum}</span>`)
...
function initializeNewRound()
{
    ...
    updateStatusElement(currentGameStatusElem, "block", 'cyan', "Shuffling...")
...
function cardFlyInEffect() {
    const id = setInterval(flyIn, 1); // Decreased the interval to 1 millisecond
    let cardCount = 0;
    let count = 0;
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", 'cyan', "Click the card that you think is the Ace of Spades...")
...
function randomizeCardPositions() {
    for (let i = 0; i < numCards; i++) {
        ...
        cardPositions[i] = cardPositions[randomIndex];
        cardPositions[randomIndex] = temp;
    }
}
